    ...
    <main>
      ...
      <div className="width-container">
        ...
        <div className="hoz-padding">
          ...
          <br></br>
          <p>You can find out anything else you need by visting Eastington Park's website <a href="https://www.eastingtonpark.co.uk/" target='_blank' rel='no-follow'>www.eastingtonpark.co.uk</a></p>
          <br></br>
        </div>
